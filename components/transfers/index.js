    ...
    <div className="max-w-full space-y-8 sm:space-y-12 mx-auto">
      <div className="w-full grid grid-flow-row grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mt-4">
        ...
        <Widget
          ...
          description={<span className="text-gray-400 dark:text-gray-500 text-xs font-normal">Total Value Locked on Gitshock Network</span>}
          className="bg-transparent sm:bg-white sm:dark:bg-gray-900 shadow border-0 px-4 sm:py-4"
        >
          <div className="flex flex-col space-y-2 mt-1">
            {crosschainTVLData ?
      ...
      <div className="max-w-7xl mx-auto">
        <Widget
          ...
          description={<span className="text-gray-400 dark:text-gray-500 text-xs font-normal">Cross-Chain on Gitshock Network</span>}
